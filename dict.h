 ...
 * three functions:
 *     - how to free each value pointer
 *     - how to compare keys for equality
 *     - how to efficiently hash keys
 * There is no support for freeing keys (yet).
 */
struct dict;
 ...
 * All previously #dict_put() values will be deallocated by calling the
 * @a free_value function if it was given to #dict_new().
 *
...
/*
 * Stores or replaces a key-value relationship in the dictionary.
