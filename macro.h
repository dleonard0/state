...
/**
 * A macro is text parameterized by an environment.
 * It is a tree-structured object, intended for expansion into a
 * string through the substitution of macro- or string-valued variables
 * of a variable scope/dictionary.
 *
 ...
 *
 * References are represented as "$(a b,c,...)". Note that
...
/**
 * Constructs a new macro containing just an atom.
 *
 * @param atom  the atom
 *
